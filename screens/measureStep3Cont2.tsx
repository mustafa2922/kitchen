...
export default function MeasureStep3Cont2() {
  ...
  return (
    <>
      <View style={[rncStyles.h100, { backgroundColor: 'white', paddingHorizontal: 20 }]}>
        ...
        <Text style={{ fontSize: 20, marginTop: 10, marginBottom: 20, color: 'black', fontWeight: "600" }}>Existing Plumbing Supply Lines</Text>
        <ScrollView>
          <View style={styles.container}>
            ...
            {rowData.map((row, index) => (
              <View style={styles.row} key={index}>
                ...
                <View style={styles.column}><TextInput style={styles.input} value={row.field5} onChangeText={(text) => handleFieldChange({ text, rowIndex: index, fieldName: 'field5' })} keyboardType="number-pad" maxLength={3} /></View>
                <View style={styles.column}><TextInput style={styles.input} value={row.field6} onChangeText={(text) => handleFieldChange({ text, rowIndex: index, fieldName: 'field6' })} keyboardType="number-pad" maxLength={3} /></View>
                <View style={styles.column}><TextInput style={styles.input} value={row.field7} onChangeText={(text) => handleFieldChange({ text, rowIndex: index, fieldName: 'field7' })} keyboardType="number-pad" maxLength={3} /></View>
              </View>
            ))}
          </View>
