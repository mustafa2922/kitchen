...
export default function MeasureStep4() {
  ...
  return (
    <>
      <View style={[rncStyles.h100, { backgroundColor: 'white', paddingHorizontal: 20 }]}>
        <Text style={{ fontSize: 15, marginTop: 20, color: 'black', fontWeight: "600", backgroundColor: 'lightgrey', paddingLeft: 3 }}>Step 4</Text>
        <Text style={{ fontSize: 20, marginTop: 10, marginBottom: 20, color: 'black', fontWeight: "600" }}>Existing Windows</Text>
        <ScrollView>
